...
SHOW DATABASES;
USE COMPANY;
CREATE TABLE EMPLOYEE(Emp_No INT PRIMARY KEY, Emp_Name VARCHAR(45), Address VARCHAR(45), Sex VARCHAR(45), Dept VARCHAR(45), 
Salary INT, DOJ VARCHAR(45), Branch VARCHAR(45));
DESC EMPLOYEE;
