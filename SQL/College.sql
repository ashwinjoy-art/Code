...
SELECT * FROM PROGRAM;
INSERT INTO STUDENT VALUES('Jibi','Babu',101,201,'2000-07-11','Female',1234567890,288118813881,2022),('Aysha','Mustafa',102,202,
'2001-09-09','Female',2345678901,299119913991,2022),('Marva','Jamal',103,203,'2001-02-15','Female',3456789012,488128813881,2022),
('Jasina','Jasi',104,204,'2000-11-10','Female',4567890123,588128813881,2022),('Ranjith','Ranji',105,205,'2000-06-19','Male',5678901234,
344356657887,2022);
SELECT * FROM STUDENT;
